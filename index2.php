...
<br><br><input type='submit' id='sub' disabled/>
<h4>already having account<a href="login.php"> sign in </a></h>
</form>
</div>
<div id="div1">
            <div id="box">
                <h4 id="box1">successfully account created</h4>
                <button id="cl" onClick="clos()">next</button>
            </div>
        </div>
</body>
